...
urlpatterns = [
    ...
    path("api/v1/", include("accommodation.api.urls")),
    path("api/v1/", include("insurance.api.urls")),
    path("api/v1/", include("loan.api.urls")),
    path("api/v1/", include("referral.api.urls")),
    path("api/v1/", include("welfare.api.urls")),
    path("api/v1/", include("finance.api.urls")),
    path("api/v1/", include("report.api.urls")),
    # OpenAPI schema + docs
